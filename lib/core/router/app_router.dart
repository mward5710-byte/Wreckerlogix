...
import '../../features/fuel_cloud/screens/fuel_cloud_screen.dart';
import '../../features/fuel_cloud/screens/fuel_cloud_settings_screen.dart';
...
class AppRouter {
  ...
  static final router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: '/fuel-cloud',
        builder: (context, state) => const FuelCloudScreen(),
      ),
      GoRoute(
        path: '/fuel-cloud/settings',
        builder: (context, state) => const FuelCloudSettingsScreen(),
      ),
    ],
  );
}
